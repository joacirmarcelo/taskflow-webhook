  ...
  if (url === "/webhook" && req.method === "POST") {
    ...
    try {
      ...
      if (needsText) {
        ...
        // Store first 12 digits for display (fingerprint-safe for Brazil)
        // Full digits still available for matching via phoneMatch()
        const phone = phoneFull.length > 12 ? phoneFull.slice(0, 12) : phoneFull;
        ...
        // Auto-reply — uses fingerprint matching
